                                        ...
                                        <div class="col-6 col-sm-6 col-md-4 col-lg-3 grid-view-item style2 item">
                                            <div class="grid-view_image">
                                                ...
                                                <a href="product-accordion.html" class="grid-view-item__link">
                                                    <!-- image -->
                                                    <img class="grid-view-item__image primary blur-up lazyload"
                                                        data-src="assetss/images/product-images/product-image17.jpg"
                                                        src="assetss/images/product-images/product-image17.jpg"
                                                        alt="image" title="product" />
                                                    <!-- End image -->
                                                    <!-- Hover image -->
                                                    <img class="grid-view-item__image hover blur-up lazyload"
                                                        data-src="assetss/images/product-images/product-image17-1.jpg"
                                                        src="assetss/images/product-images/product-image17-1.jpg"
                                                        alt="image" title="product" />
                                                    <!-- End hover image -->
                                                    <!-- product label -->
                                                    <div class="product-labels"><span class="lbl on-sale">Sale</span>
                                        ...
                                        <div class="col-6 col-sm-6 col-md-4 col-lg-3 grid-view-item style2 item">
                                            <div class="grid-view_image">
                                                ...
                                                <a href="product-accordion.html" class="grid-view-item__link">
                                                    <!-- image -->
                                                    <img class="grid-view-item__image primary blur-up lazyload"
                                                        data-src="assetss/images/product-images/product-image18.jpg"
                                                        src="assetss/images/product-images/product-image18.jpg"
                                                        alt="image" title="product" />
                                                    <!-- End image -->
                                                    <!-- Hover image -->
                                                    <img class="grid-view-item__image hover blur-up lazyload"
                                                        data-src="assetss/images/product-images/product-image18-1.jpg"
                                                        src="assetss/images/product-images/product-image18-1.jpg"
                                                        alt="image" title="product" />
                                                    <!-- End hover image -->
                                                </a>
                                                <!-- end product image -->
                                        ...
                                        <div class="col-6 col-sm-6 col-md-4 col-lg-3 grid-view-item style2 item">
                                            <div class="grid-view_image">
                                                ...
                                                <a href="product-accordion.html" class="grid-view-item__link">
                                                    <!-- image -->
                                                    <img class="grid-view-item__image primary blur-up lazyload"
                                                        data-src="assetss/images/product-images/product-image19.jpg"
                                                        src="assetss/images/product-images/product-image19.jpg"
                                                        alt="image" title="product" />
                                                    <!-- End image -->
                                                    <!-- Hover image -->
                                                    <img class="grid-view-item__image hover blur-up lazyload"
                                                        data-src="assetss/images/product-images/product-image19-1.jpg"
                                                        src="assetss/images/product-images/product-image19-1.jpg"
                                                        alt="image" title="product" />
                                                    <!-- End hover image -->
                                                </a>
                                                <!-- end product image -->
