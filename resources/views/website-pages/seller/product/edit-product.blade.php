                                    ...
                                    <div class="active tab-pane">
                                        <form method="POST"
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control " name="name"
                                                        value="{{ $products->name }}" required id="name">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="number" class="form-control " name="price"
                                                        value="{{ $products->price }}" required id="price">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <textarea rows="4" class="form-control" name="description">{{ old('description', $products->description) }}</textarea>
