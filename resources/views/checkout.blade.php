                            ...
                            <form>
                                <fieldset>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-12 col-lg-12 col-xl-12 required">
                                            ...
                                            <input name="firstname" value="{{ Auth::user()->name }}" id="input-firstname" type="text" required>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-6 col-lg-6 col-xl-6 required">
                                            ...
                                            <input name="email" value="{{ Auth::user()->email }}" id="input-email" type="email" required>
                                        </div>
                                        <div class="form-group col-md-6 col-lg-6 col-xl-6 required">
                                            <label for="input-telephone">Telephone <span class="required-f">*</span></label>
                                            <input name="telephone" value="{{ Auth::user()->phone }}" id="input-telephone" type="number" required>
                                        </div>
                                    </div>
                                </fieldset>
                                ...
                                <fieldset>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-6 col-lg-6 col-xl-6 required">
                                            <label for="input-province">Province <span class="required-f">*</span></label>
                                            <input name="province" value="" id="input-province" type="text" required>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="form-group col-md-6 col-lg-6 col-xl-6 required">
                                                    ...
                                                    <div class="card-body">
                                                        <fieldset>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="form-group col-md-6 col-lg-6 col-xl-6 required">
                                                                    <img class="padding-25px-top xs-padding-5px-top" src="assetss/images/payment-img.jpg" alt="card" title="card" />
                                                                </div>
                                                            </div>
                                                        </fieldset>
