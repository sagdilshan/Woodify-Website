                ...
                @auth
                    @if (Auth::user()->role == 'admin')
                        <a href="{{ url('/admin/dashboard') }}"
                            class="font-semibold text-gray-600 hover:text-gray-900 dark:text-dark-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Dashboard</a>
                        <span class="ml-4"></span>
                        {{-- <a href="{{ route('admin.logout') }}"
                            class="font-semibold text-gray-600 hover:text-gray-900 dark:text-dark-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Log
                            Out</a> --}}
